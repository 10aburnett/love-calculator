...
export default function Footer() {
  ...
  const shareToInstagram = async () => {
    alert(t('footer.copyForInstagram') + '\n\n' + shareText + '\n\n' + window.location.origin);
  };

  const shareToTikTok = async () => {
    alert(t('footer.createTikTok') + '\n\n' + shareTextShort + ' ' + t('common.share.hashtags') + '\n\n' + window.location.origin);
  };
  ...
  const shareToReddit = () => {
    const title = t('footer.shareRedditTitle') || 'Discover Your Love Compatibility!';
    const text = t('footer.shareRedditText') || 'Fun and entertaining Love Calculator - Test your relationship compatibility and share your results with friends!';
    const url = `https://reddit.com/submit?url=${encodeURIComponent(window.location.origin)}&title=${encodeURIComponent(title)}&text=${encodeURIComponent(text)}`;
    window.open(url, '_blank');
  };
  ...
  return (
    <footer className="bg-white/95 backdrop-blur-sm border-t border-gray-200 shadow-sm mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              <Heart className="w-8 h-8 text-[var(--love-pink)]" />
              <span className="text-xl font-playfair font-bold text-gray-900">Love Calculator</span>
            </div>
            <p className="text-gray-600 text-sm mb-4">
              {t('footer.description') || 'Discover love compatibility through our advanced algorithm. Find your perfect match with scientifically-backed love analysis.'}
            </p>
            ...
            <div className="mb-4">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    ...
                    className="flex items-center justify-center p-3 rounded-lg transition-all duration-200 btn-love"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mt-2">
                  ...
                  >
                    ...
                    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#E6E300'}
                    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#FFFC00'}
                  >
                    <svg className="w-5 h-5" viewBox="147.353 39.286 514.631 514.631" style={{ shapeRendering: 'geometricPrecision' }}>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-600 text-sm mb-4 md:mb-0">
              © 2025 Love Calculator. {t('footer.allRightsReserved') || 'All rights reserved.'}
            </div>
