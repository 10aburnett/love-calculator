...
export const metadata: Metadata = {
  ...
  description: 'Contact Love Calculator - Get in touch with our team for questions, feedback, or support about our fun love compatibility tests and entertainment services.',
  keywords: ['contact', 'support', 'love calculator contact', 'help'],
  alternates: {
    canonical: '/contact',
  },
  openGraph: {
    title: 'Contact Us - Love Calculator',
    description: 'Contact Love Calculator - Get in touch with our team for questions and support.',
    url: '/contact',
    type: 'website',
  },
};
