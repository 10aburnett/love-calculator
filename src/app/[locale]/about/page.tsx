        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-6">
              ...
              >
                <div className="inline-flex items-center bg-gradient-to-r from-emerald-100 to-blue-100 border border-emerald-200 rounded-full px-4 py-2">
        ...
        <section className="py-8">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div 
              ...
              className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-2xl p-8 mb-8 card-hover scale-in"
            >
              <div className="text-center">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {[
                    { icon: "🎯", title: "5-Metric Analysis", desc: "Advanced scoring across multiple scientific dimensions" },
                    { icon: "📊", title: "Visual Insights", desc: "Interactive breakdowns showing exactly how scores are calculated" },
                    { icon: "🔬", title: "Research-Based", desc: "Grounded in academic literature and proven methodologies" }
                  ].map((item, index) => (
                    <motion.div 
                      key={item.title}
                      initial={{ opacity: 0, y: 20 }}
