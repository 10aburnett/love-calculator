      ...
      <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 page-transition">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-6">
              ...
              <motion.h1 
                ...
                className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-playfair font-bold text-gray-900 mb-6 fade-in"
              >
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 mx-4">
